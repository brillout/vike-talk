...
> [!NOTE]
> Deployment:
> - To change branch deployed to `talk.vike.dev`, update `on.push.branches` at [`.github/workflows/website.yml`](https://github.com/brillout/vike-talk/blob/main/.github/workflows/website.yml).
> - To permanently deploy a branch:
>   1. Create a copy of this repository (GitHub doesn't allow same-repo forks)
...
>   1. `git checkout yyyy-conf-name && git push yyyy-conf-name main`
