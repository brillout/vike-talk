      ...
      >
        ...
        >
          <span style={{ display: 'block' }}>
            <span style={{ fontWeight: 600, color: '#555' }}>Minimal-lock-in</span> framework powering mission-critical
          </span>
          <span style={{ display: 'block' }}>applications with unmatched stability and development freedom.</span>
        </p>
